        ...
        <form id="projectSettingsForm" method="POST" action="<?php echo e(route('projects.updateSettings', $project)); ?>">
            ...
            <div class="mb-8">
                ...
                <div id="phasesList" class="space-y-3 mb-3">
                    ...
                    ?>
                    <?php $__empty_1 = true; $__currentLoopData = $settingsPhases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $parts      = explode('|', $phase);
...
<?php endif; ?>
<?php /**PATH C:\iPROJECT\iproject-laravel-complete\iproject-laravel\resources\views/projects/partials/_slideout-settings.blade.php ENDPATH**/ ?>