...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="<?php echo e(route('companies.show', $company)); ?>" class="text-primary-600 hover:text-primary-900">
                    ← Back to Company
                </a>
            </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="num_of_licensed_users" id="num_of_licensed_users" 
                                               value="<?php echo e(old('num_of_licensed_users', $company->num_of_licensed_users ?? 1)); ?>" 
                                               min="1"
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" 
                                               required>
                                        <p class="mt-1 text-sm text-gray-500">
                                            Current usage: <?php echo e($company->activeUserCount()); ?> active user(s)
                                        </p>
                                        <?php $__errorArgs = ['num_of_licensed_users'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <?php if($company->logo): ?>
                                        <div class="mb-2">
                                            <img src="<?php echo e(Storage::url($company->logo)); ?>" alt="Current logo" class="w-32 h-32 object-cover rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="type" id="type" 
                                           value="<?php echo e(old('type', $company->type)); ?>"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="4"
                                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('description', $company->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="user_roles" id="user_roles" rows="4"
                                          ...
                                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('user_roles', $company->user_roles)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="rss" id="rss" 
                                       value="<?php echo e(old('rss', $company->rss)); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="ticket_priorities" id="ticket_priorities" rows="5"
                                              ...
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 font-mono text-sm"><?php echo e(old('ticket_priorities', $company->ticket_priorities ?: "Low|500|1000\nMed|200|400\nHigh|100|200\nUrgent|30|60")); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="ticket_categories" id="ticket_categories" rows="5"
                                              ...
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('ticket_categories', $company->ticket_categories)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="ticket_close_reasons" id="ticket_close_reasons" rows="4"
                                          ...
                                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('ticket_close_reasons', $company->ticket_close_reasons)); ?></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <select name="ticket_notification" id="ticket_notification"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                                        <option value="No" <?php echo e(old('ticket_notification', $company->ticket_notification) == 'No' ? 'selected' : ''); ?>>No</option>
                                        <option value="Yes" <?php echo e(old('ticket_notification', $company->ticket_notification) == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="ticket_notify_email" id="ticket_notify_email" 
                                           value="<?php echo e(old('ticket_notify_email', $company->ticket_notify_email)); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="tracker_priorities" id="tracker_priorities" rows="5"
                                              placeholder="Low|500|1000&#10;Med|200|400&#10;High|100|200&#10;Urgent|30|60"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 font-mono text-sm"><?php echo e(old('tracker_priorities', $company->tracker_priorities ?: "Low|500|1000\nMed|200|400\nHigh|100|200\nUrgent|30|60")); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="tracker_categories" id="tracker_categories" rows="5"
                                              placeholder="Bug&#10;Feature Request&#10;Enhancement&#10;Documentation"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('tracker_categories', $company->tracker_categories)); ?></textarea>
                                    <p class="mt-1 text-sm text-gray-500">One category per line</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="tracker_close_reasons" id="tracker_close_reasons" rows="4"
                                              placeholder="Fixed&#10;Won't Fix&#10;Duplicate&#10;Cannot Reproduce"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('tracker_close_reasons', $company->tracker_close_reasons)); ?></textarea>
                                    <p class="mt-1 text-sm text-gray-500">One reason per line</p>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="tracker_phase" id="tracker_phase" rows="4"
                                              ...
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"><?php echo e(old('tracker_phase', $company->tracker_phase)); ?></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <select name="tracker_notification" id="tracker_notification"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                                        <option value="No" <?php echo e(old('tracker_notification', $company->tracker_notification) == 'No' ? 'selected' : ''); ?>>No</option>
                                        <option value="Yes" <?php echo e(old('tracker_notification', $company->tracker_notification) == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="tracker_notify_email" id="tracker_notify_email" 
                                           value="<?php echo e(old('tracker_notify_email', $company->tracker_notify_email)); ?>"
...
<?php endif; ?><?php /**PATH C:\iPROJECT\iproject-laravel-complete\iproject-laravel\resources\views/companies/edit.blade.php ENDPATH**/ ?>