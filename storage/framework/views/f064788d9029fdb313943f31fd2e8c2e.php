    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 px-4 py-3 mb-5">
        <form method="GET" action="<?php echo e(route('projects.index')); ?>"
            ...
            <div class="flex-shrink-0 flex items-end gap-2 pb-0">
                ...
                <?php if(request()->hasAny(['search', 'department_id', 'status'])): ?>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-3 whitespace-nowrap">
                                <div class="flex items-center gap-2.5">
                                    <div class="w-2.5 h-2.5 rounded-full flex-shrink-0"
                                         style="background-color: #<?php echo e($project->color_identifier); ?>"></div>
                                    <div>
                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($project->name); ?></div>
                                        <?php if($project->short_name): ?>
                                        <div class="text-xs text-gray-400"><?php echo e($project->short_name); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-5 py-3 whitespace-nowrap">
                                ...
                                ?>
                                <span class="px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($cls); ?>">
                            ...
                            <td class="px-5 py-3 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs text-gray-500 w-8"><?php echo e($project->percent_complete); ?>%</span>
                                </div>
                            </td>
                            ...
                            <td class="px-5 py-3 whitespace-nowrap text-right">
                                <div class="inline-flex items-center gap-1 justify-end">
                                    ...
                                    <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST"
                                          ...
                                          onsubmit="return confirm('Delete project \'<?php echo e(addslashes($project->name)); ?>\'?\n\nThis cannot be undone.')">
                                        <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            <div class="text-center py-16">
                ...
                <a href="<?php echo e(route('projects.create')); ?>" class="btn-primary inline-flex items-center gap-2 px-4">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                    New Project
