...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="<?php echo e(route('users.index')); ?>" class="text-primary-600 hover:text-primary-900">
                    ← Back to Users
                </a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="<?php echo e(route('users.store')); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="inactive" <?php echo e(old('status') == 'inactive' ? 'selected' : ''); ?>>Inactive (Ghost)</option>
                    ...
                    <div class="mb-6 border-t pt-6">
                        ...
                        <div class="mt-4">
                            ...
                            <input 
                                ...
                                name="hourly_cost" 
                                id="hourly_cost"
                                value="<?php echo e(old('hourly_cost', 0)); ?>"
                                min="0"
                                step="0.01"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                            >
                            ...
                            <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    ...
                                    <input type="number" 
                                           ...
                                           max="24" 
                                           step="0.5"
                                           value="<?php echo e(old('availability.'.$index, $defaults[$index])); ?>"
                    ...
                    <div class="mb-6 border-t pt-6">
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(auth()->user()->company_id === null || !in_array($role->name, ['super_admin', 'cloud_manager'])): ?>
                                <label class="flex items-center">
                                    ...
                                    >
                                    <span class="ml-2 text-sm text-gray-700"><?php echo e(ucfirst(str_replace('_', ' ', $role->name))); ?></span>
                                </label>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div class="flex justify-end gap-2 border-t pt-6">
                        <a href="<?php echo e(route('users.index')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-blue-300">
                            Cancel
                        </a>
...
<?php endif; ?><?php /**PATH C:\iPROJECT\iproject-laravel-complete\iproject-laravel\resources\views/users/create.blade.php ENDPATH**/ ?>