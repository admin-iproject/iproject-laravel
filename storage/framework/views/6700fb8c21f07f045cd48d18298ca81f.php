...
<div id="ticketConfigSlideout"
    ...
    <div class="flex border-b border-gray-200 bg-white flex-shrink-0 overflow-x-auto">
        ...
        <button onclick="switchConfigTab('<?php echo e($tab['id']); ?>')"
                id="cfgTab_<?php echo e($tab['id']); ?>"
...
<?php /**PATH C:\iPROJECT\iproject-laravel-complete\iproject-laravel\resources\views/tickets/modals/_ticket-config-slideout.blade.php ENDPATH**/ ?>