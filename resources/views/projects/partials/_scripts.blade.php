{{-- ============================================================
     PROJECT SHOW — STYLES + SCRIPTS
     Inline: Blade globals (projectId, csrf, user data)
     External: project-show.js, project-tasks.js, project-team.js
     ============================================================ --}}
...
@endphp
let allTeamMembers = @json($projectTeamForJs);
let editingTeamId  = null;

// Route URLs — injected here so JS files have no Blade dependency
window._taskStoreUrl       = '{{ route("tasks.store") }}';
