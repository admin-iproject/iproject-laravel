    ...
    <div class="absolute right-0 top-0 h-full w-full max-w-xl bg-white shadow-2xl flex flex-col">
        ...
        <div class="flex-shrink-0 border-b border-gray-200">
            ...
            <div id="logFormBody" class="hidden px-5 py-4 bg-amber-50/30">
                ...
                {{-- Hourly rate / cost estimate line — populated by JS --}}
                ...
                {{-- Row 4: Assigned User — 2-column radio grid, populated by JS --}}
                ...
                {{-- Inline confirm banner — shown by JS instead of browser confirm() --}}
        ...
        <div class="flex-1 overflow-y-auto">
            <div class="px-5 py-3 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    {{-- Total cost — shown to project owners only, populated by JS --}}
